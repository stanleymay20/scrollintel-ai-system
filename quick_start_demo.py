#!/usr/bin/env python3
"""
Quick Start Demo for ScrollIntel
Runs both backend and opens frontend
"""
...
# Simple HTTP server for the backend
...
def start_backend():
    ...
    print(f"🚀 ScrollIntel Backend running on: http://127.0.0.1:{port}")
...
def main():
    """Main function"""
    print("🌟 ScrollIntel Quick Start Demo")
    print("=" * 50)
    ...
    print()
    print("✅ ScrollIntel Demo is running!")
